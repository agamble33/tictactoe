...
export class AddNewSuperUserComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.superUserVo = Object.assign( {}, this.selectedObj );
        ...
        if ( this.superUserVo && this.superUserVo.id ) {
            this.newSuperUserVo = {
                ...
                role: this.superUserVo.Identity.role_id,
    ...
    //     this.newSuperUserVo.role = "1";
    //   } else {
    //     this.newSuperUserVo.role = "4";
    //   }
    // };
  ...
  onRoleChange(selectedValue) {
    ...
    if(foundRole) {
      console.log(foundRole)
        ...
        this.newSuperUserVo.role = foundRole.value;
    }
