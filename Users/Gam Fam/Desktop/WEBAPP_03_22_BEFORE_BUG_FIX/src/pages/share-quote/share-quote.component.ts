...
export class ShareQuoteComponent implements OnInit {
    ...
    constructor(private locstr: LocalStorageService, public activeModal: NgbActiveModal,
        ...
        private manageOrgUserService: ManageOrgUserService,  private router: Router,
    ...
    ngOnInit() {
        ...
        .subscribe( message => {
          ...
          // console.log('WHERE', this.email.quote.QuotationType);
        } );
        ...
        if(this.userService.getUser()){
            ...
            if(this.loggedInUserData.role != 'ORG_ADMIN'){
                if(shareQuoteVo.is_specific_organization){
                   ...
                   // console.warn('WHERE', this.quoteType);
 ...
 * */
    ...
    */
    ...
    onQuoteSelect(event) {
        var self = this;
       // console.warn(this.email.quoteType)
        setTimeout(() => {
