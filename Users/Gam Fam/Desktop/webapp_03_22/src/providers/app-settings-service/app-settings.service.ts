...
export class AppSettings {
  ...
  public static get BASE_URL(): string {
    if (Constants.CURRENT_ENVIRONMENT == 'production') {
      ...
      // return 'http://192.168.1.214:4500/api/v1/';
         ...
         return 'http://localhost:49217/api/v1/';

    } else { return "http://panelbuilder-qa.us-east-1.elasticbeanstalk.com/api/v1/";
     // 'http://192.168.1.214:4500/api/v1/';
  ...
  public static get UPDATE_POST_URL(): string { return 'users/notifications'; }
