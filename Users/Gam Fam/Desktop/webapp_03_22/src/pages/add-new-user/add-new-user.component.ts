    ...
    ngOnInit() {
        ...
        if (this.userVo && this.userVo.id) {
            this.newUserVo = {
              ...
              profileImageUrl: this.userVo.profileImageUrl
                ? this.userVo.profileImageUrl
                : "https://configuratortestenv.s3.amazonaws.com/profile/user/234.jpeg%3F1521172188270",
              can_only_view_quote: this.userVo.Identity.can_only_view_quote,
             // assignSuperUser: this.newUserVo.assignSuperUser,
              user_id: this.userVo.id,
              identity_id: this.userVo.Identity.id,
              QuotationTypes: this.newUserVo.QuotationTypes
            };
            console.log("ROLEBABY11", this.newUserVo);
            console.log("ROLEBABY22");
            console.log("ROLEBABY33", this.newUserVo);
            ...
            this.newUserVo = {
              ...
              profileImageUrl:
                "https://configuratortestenv.s3.amazonaws.com/profile/user/234.jpeg%3F1521172188270",
              can_only_view_quote: false,
              //assignSuperUser: this.newUserVo.assignSuperUser ? "SUPER_USER" : "USER",
              user_id: "",
              identity_id: "",
              QuotationTypes: []
            };
        ...
        changeUserRole = event => {
            ...
            if (event.target.checked) {
              this.newUserVo.role = 4;
            } else {
              this.newUserVo.role = 1;
            }
          };
