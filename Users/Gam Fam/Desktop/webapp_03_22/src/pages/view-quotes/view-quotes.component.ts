      ...
      if (fromDate < initialFromDate) {
        ...
        if (diffDays > 0 && diffDays < 61) {
          ...
          if (diffDays < 1) {
            ...
            this.errorMsg = "Date range should be between 60 days";
          }
        }
      }
    } else {
      ...
      res => {
        ...
        if (viweQuote) {
          if (filterViewdata) {
            ...
            console.log('WHERE',this.searchField)
            console.log('WHERE',this.search)
          }
